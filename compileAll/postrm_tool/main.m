...
int main() {
    ...
    [fileManager removeItemAtPath:@"/private/var/mobile/Library/SplashBoard/Snapshots/org.brandonplank.mobilecracker" error:nil];
    [fileManager removeItemAtPath:@"/private/var/mobile/Library/Preferences/org.brandonplank.mobilecracker.plist" error:nil];
    run_system("uicache");
    for (NSString *dataList in [fileManager contentsOfDirectoryAtPath:@"/private/var/mobile/Containers/Data/Application" error:nil]) {
        ...
        if ([fileManager fileExistsAtPath:metadata]) {
            ...
            if (dict != nil) {
                if ([dict[@"MCMMetadataIdentifier"] isEqual:@"org.brandonplank.mobilecracker"]) {
                    if ([fileManager fileExistsAtPath:[NSString stringWithFormat:@"/private/var/mobile/Containers/Data/Application/%@/Library/Preferences/org.brandonplank.mobilecracker.plist", dataList]]) {
